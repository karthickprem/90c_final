                    ...
                    async with websockets.connect(WS_URL, ping_interval=30, ping_timeout=10) as ws:
                        ...
                        while True:
                            ...
                            try:
                                ...
                                if up_position is None and not up_tp_hit and up_book.valid and up_book.best_ask >= ENTRY_THRESHOLD and up_book.best_ask <= MAX_ENTRY_THRESHOLD and up_spread <= 0.02 and in_entry_window:  # 2c max spread + last 6 min + 90-97c range
                                ...
                                if down_position is None and not down_tp_hit and down_book.valid and down_book.best_ask >= ENTRY_THRESHOLD and down_book.best_ask <= MAX_ENTRY_THRESHOLD and down_spread <= 0.02 and in_entry_window:  # 2c max spread + last 6 min + 90-97c range
                                    # NOTE: Removed cancel_all() - it cancels ALL markets!
                                    # The 60s polling + specific order cancel handles orphan orders
